...
void WMainMenuBar::initialize() {
    ...
    QString show4DecksText = tr("Show 4 Decks on the Mixxx interface.") +
            " " + mayNotBeSupported;
    auto pViewShow4Decks = new QAction(show4DecksTitle, this);
    ...
    QString showLibraryText = tr("Show the library of the Mixxx interfce.") +
            " " + mayNotBeSupported;
    auto pViewShowLibrary = new QAction(showLibraryTitle, this);
    ...
    QString showSpinniesText = tr("Show the spinnining vinyl widget on the Mixxx interface.") +
            " " + mayNotBeSupported;
    auto m_pViewShowSpinnies = new QAction(showSpinniesTitle, this);
    ...
    QString showMixerText = tr("Show the mixer section.") +
            " " + mayNotBeSupported;
    auto pViewShowMixer = new QAction(showMixerTitle, this);
    ...
    QString showEqsText = tr("Show the equalizers on the mixer section.") +
            " " + mayNotBeSupported;
    auto pViewShowEqs = new QAction(showEqsTitle, this);
    ...
    QString showXFaderText = tr("Show the crossfader on the mixer section.") +
            " " + mayNotBeSupported;
    auto m_pViewShowXFader = new QAction(showXFaderTitle, this);
